    ...
    <div className="px-7 md:px-[106px] mb-36">
      <section className="flex flex-col items-center md:flex-row gap-5">
        ...
        <div className="flex flex-col justify-around items-center lg:items-start gap-3">
          <h3 className="dark:text-white-1 text-purple-1 text-sizeTitle">{member?.name}</h3>

          <span className="dark:text-white-1 text-purple-1 text-sizeParagraph">{member?.subTitle}</span>
      ...
      <section className="my-14 ">
        <div className="flex gap-3 justify-center md:justify-normal">
          <button onClick={() => setShowProjects(!showProjects)} className='bg-green-1 dark:bg-purple-2 rounded-md p-2 '>
