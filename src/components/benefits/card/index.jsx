...
const Card = ({ title, text, icon }) => {
  return (
    <div className="bg-white-2 dark:bg-purple-2 drop-shadow-customized dark:drop-shadow-none rounded-lg flex flex-col gap-2 p-8   w-mini h-small lg:gap-4 lg:h-larger">
