    ...
    <section className="w-full bg-purple-1">
      <div className="flex flex-wrap px-4 justify-around gap-4 w-full mx-auto md:justify-between md:max-w-medium lg:max-w-larger lg:px-0 lg:justify-center ">
        <div className="max-w-sm   pr-8">
          <h2 className="font-black text-gray-1 border-purple-3 leading-mobile-ultra pb-4 mb-2 border-x-0 border-t-0 border-solid border-2 text-desktop-extraMedium font-inconsolata lg:text-desktop-extraUltra lg:leading-desktop-ultra lg:pb-8 lg:mb-8">
            Vantagens do <br /> Projeto
          </h2>

          <p className="text-xs font-normal leading-mobile-mini text-gray-0 font-mulish lg:text-lg lg:leading-desktop-larger">
